  ...
  return (
    <div className="flex items-center gap-2 select-none py-0.5" aria-label="Tiến độ công việc">
      <div
        ...
        className="h-2 flex-1 overflow-hidden rounded-full bg-[#E5E5EA] dark:bg-[#2C2C2E]"
      >
        <div
          className="h-full bg-[#1C1917] dark:bg-white rounded-full transition-[width] duration-300"
          style={{ width: `${progressPercent}%` }}
        />
      </div>
      <span className="font-mono text-xs font-black text-[#1C1917] dark:text-[#F2F2F7] shrink-0">
