  ...
  (
    ...
    return (
      <textarea
        ...
        rows={minRows}
        className={`w-full bg-[#FCFBF9] text-[#1C1917] placeholder-[#A8A29E] border-[1.5px] border-[#262626] rounded-none px-3.5 py-2.5 text-xs sm:text-sm font-sans focus:outline-none focus:bg-white focus:shadow-[2px_2px_0px_#262626] transition-all resize-none leading-relaxed ${className}`}
        {...props}
      />
    );
  }
