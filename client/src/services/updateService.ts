...
export const checkForAppUpdates = async (): Promise<UpdateInfo | null> => {
  for (const url of SOURCES) {
    try {
      ...
      // Nếu người dùng đã bỏ qua hoặc đã cập nhật version này -> Không hiện lại
      const dismissed = localStorage.getItem("sketchtask_dismissed_version");
      ...
      return {
        ...
        apkUrl:
          data.apkUrl || "https://github.com/Tonyisme1/sketchtask-app/actions",
