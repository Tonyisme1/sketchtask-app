...
import { TabletTodayView } from "./TabletTodayView";
...
export interface TabletTasksViewProps {
  navigationTarget?: NavigationTarget;
  onClearNavigationTarget?: () => void;
}

export const TabletTasksView: React.FC<TabletTasksViewProps> = ({
  navigationTarget,
  ...
  return (
    <div className="space-y-4 w-full min-w-0 pb-12 select-none animate-in fade-in duration-150">
      {/* 1. Chỉ hiển thị chế độ của workspace Công việc; Hôm nay là workspace riêng. */}
