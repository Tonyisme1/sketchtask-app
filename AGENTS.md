...
Tài liệu này là chỉ thị tối cao dành cho AI Coding Agent khi làm việc trên dự án này.
Trước khi viết hoặc chỉnh sửa bất kỳ dòng code UI/Frontend nào, bạn BẮT BUỘC phải đọc và áp dụng các quy tắc dưới đây cùng toàn bộ tài liệu trong thư mục `.design/`.
...
1. **Đọc ngữ cảnh:** Tham chiếu `.design/DESIGN-PRINCIPLES.md`, `.design/TOKENS.md`, và `.design/COMPONENTS.md`.
...
4. **Tự kiểm tra (Self-Audit):** Rà soát lại mã nguồn dựa trên danh sách _Negative Constraints_ ở Mục 2.
